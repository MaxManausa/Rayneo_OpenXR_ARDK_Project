...
public class WhaleSceneCtrl : MonoBehaviour
{
    public LatticeButton m_WhaleBtn;
    ...
    void Start()
    {
        ...
        m_WhaleBtn.onClick.AddListener(ToWhaleSlamScene);
    ...
    private void ToWhaleSlamScene()
    {
        SceneManager.LoadScene("WhaleSlam");
